...
class MyDatabaseHelper extends SQLiteOpenHelper {
    ...
    void addAlarm(String repeatable, String disable, int minutes, int hours){
        SQLiteDatabase db = this.getWritableDatabase();
        ContentValues cv = new ContentValues();

        cv.put(COLUMN_REPEATABLE, repeatable);
        ...
        if(result == -1){
            ...
            Toast.makeText(context, "The signal has been added!", Toast.LENGTH_SHORT).show();
        }
    }
    ...
    void updateData(String row_id, String repeatable, String disable, String hours, String minutes){
        SQLiteDatabase db = this.getWritableDatabase();
        ContentValues cv = new ContentValues();
        cv.put(COLUMN_REPEATABLE, repeatable);
        cv.put(COLUMN_DISABLE, disable);
        ...
        if(result == -1){
            ...
            Toast.makeText(context, "The signal updated Successfully!", Toast.LENGTH_SHORT).show();
        }
